  ...
  const StatusIndicator = ({ status }) => {
    ...
    return (
      <div className="flex items-center space-x-2">
        <div
          className={`w-2 h-2 rounded-full ${config.color} ${status === "online" ? "animate-pulse" : ""}`}
        />
                    ...
                    <div
                      className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                        deployment.status === "active"
                          ...
                          : deployment.status === "rollback-available"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
            {[
              ...
              },
              {
                icon: Pause,
                label: "Pause Service",
                color: "from-yellow-500/20 to-amber-600/20 text-yellow-400",
              },
              {
                icon: Square,
                label: "Stop Service",
              ...
              >
                <div
                  className={`w-10 h-10 rounded-lg bg-gradient-to-br ${action.color} flex items-center justify-center mb-3 group-hover:scale-110 transition-transform mx-auto`}
                >
