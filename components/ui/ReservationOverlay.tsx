...
export default function GlobalReservationOverlay() {
  ...
  if (isMinimized) {
    ...
    let bgColor = 'bg-[#FFE5D6]';
    let borderColor = 'border-[#FFCBA8]';
    let statusMessage = 'Verifying reservation...';
    let showSpinner = true;
    let textColorSecondary = 'text-[#8B4513]';
    ...
    return (
      <div className="fixed top-4 right-4 z-[9999] animate-in slide-in-from-top-4 fade-in duration-300">
        <div className={`relative rounded-xl border ${borderColor} ${bgColor} shadow-2xl p-2.5 w-[240px]`}>
          <div className="flex items-center gap-2">
            <div className="relative flex-shrink-0">
              <div className={`w-7 h-7 rounded-full border ${borderColor} bg-white flex items-center justify-center`}>
              ...
              <div className="flex items-center gap-1.5">
                ...
                {reservationCode && (
                  <>
                    ...
                    <span className={`font-mono text-[10px] ${textColorSecondary}`}>{reservationCode}</span>
                  </>
                )}
              </div>
              <p className={`text-[10px] ${textColorSecondary} mt-0.5 truncate`}>
                {statusMessage}
              </p>
            </div>
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              ...
              >
                <CalendarCheck2 className={`h-3.5 w-3.5 ${textColorSecondary}`} />
              </button>
              <button
                ...
                title="Dismiss"
              >
                <X className={`h-3.5 w-3.5 ${textColorSecondary}`} />
              </button>
            </div>
          </div>
        </div>
  ...
  // Full overlay
  return (
    <div className="fixed inset-0 z-[9999] bg-[#121212] flex flex-col items-center justify-center">
        ...
        {!showSuccess && !timedOut ? (
          ...
          <>
            <div className="mb-8 sm:mb-10 text-center">
              <div className="mx-auto h-12 w-12 sm:h-14 sm:w-14 rounded-2xl border border-gray-700 bg-gray-800 flex items-center justify-center">
            ...
            <div className="relative mb-8 sm:mb-10">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full border border-gray-700" />
              ...
              <div className="absolute inset-2 sm:inset-3 w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#CC5500] flex items-center justify-center">
                <div className="h-6 w-6 sm:h-8 sm:w-8 rounded-full bg-[#AA4500] animate-ping" />
              </div>
            </div>
            ...
            <div className="text-center mb-6 sm:mb-8 max-w-sm">
              ...
              <p className="text-base sm:text-lg text-gray-300 transition-all duration-500 ease-in-out px-4">
            ...
            <div className="flex flex-col gap-2 sm:gap-3 items-center w-full max-w-xs">
              <Button
                ...
                variant="outline"
                size="lg"
                className="w-full px-6 border-gray-600 text-white hover:bg-gray-800"
              >
                Continue browsing
              </Button>
          ...
          <div className="text-center animate-in fade-in duration-300 max-w-md w-full">
            <div className="mx-auto mb-6 sm:mb-8 h-14 w-14 sm:h-16 sm:w-16 rounded-full bg-amber-900 border border-amber-700 flex items-center justify-center">
            ...
            {reservationCode && (
              <div className="mt-5 sm:mt-6 mx-4 inline-flex items-center gap-3 sm:gap-4 rounded-2xl border border-gray-700 bg-gray-800 px-4 sm:px-5 py-3 sm:py-4">
                ...
                <button
                  ...
                  className="rounded-xl border border-gray-700 bg-gray-900 p-2 text-gray-400 hover:text-white hover:border-gray-600 flex-shrink-0"
          ...
          // Success State
          <div className="text-center animate-in fade-in duration-300 max-w-md w-full">
            <div className="mx-auto mb-6 sm:mb-8 h-14 w-14 sm:h-16 sm:w-16 rounded-full bg-green-900 border border-green-700 flex items-center justify-center">
